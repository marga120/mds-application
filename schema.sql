...
CREATE TABLE IF NOT EXISTS application_info (
    user_code VARCHAR(10) PRIMARY KEY REFERENCES applicant_info(user_code),
    sent VARCHAR(100) DEFAULT 'Not Reviewed' CHECK (sent IN ('Not Reviewed', 'GPA Review @ CoGS', 'Reviewed by PPA', 'Need Jeff''s Review', 'Need Khalad''s Review', 'Waitlist', 'Declined', 'Send Offer to CoGS', 'Offer Sent to CoGS', 'Offer Sent to Student', 'Offer Accepted', 'Offer Declined')),
