...
def read_schema_file():
    ...
    try:
        ...
        print("Error: schema.sql file not found. Make sure it exists in the project root.")
        return None
    except Exception as e:
...
def execute_schema_statements(cursor, schema_content):
    ...
    # First, let's handle this differently - preserve original formatting for functions
    statements = []
    current_statement = ""
